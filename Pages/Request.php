        ...
        <ul class="nav__list">
          ...
          <li class="nav__item nav__dropdown">
            ...
            <ul class="SubMenu">
              ...
              <li><a href="Request.php" class="nav__link active-link neon_eff">Request Car</a></li>
    ...
    <div class="CenterDivs">
        <div class="MainContainer">
            <div class="LeftSide">
                ...
                <img style="width: 100%;" src="https://images.cars.com/cldstatic/wp-content/uploads/can-you-order-a-car-scaled.jpg" />
                <div style="background-color: hsla(0, 0%, 100%, 0.1); width: 100%; margin: 20px; border-radius: 10px;">
                    <p style="margin: 10px; text-align: justify;" class="about__card-description">
                        Our car search service offers customers a way to find the perfect car. Customers can send us their desired car specifications, and we will use our extensive network and resources to find a matching car. Our car
                        search service offers personalized and hassle-free assistance to customers by matching their unique requirements with suitable vehicles and helping them secure the best possible deal.
                    </p>
                </div>
            </div>
            <div class="vl"></div>
            <div class="Sell1FormDiv">
                <form action="" method="POST" class="Sell1Form">
                    ...
                    <div class="InputContainer">
                        <div class="formsection">
                            <div class="formcontainer">
                                <div class="entryarea">
                                    <input type="text" name="OfferingPrice" required />
                ...
                <?php if (
                              ...
                              if ($conn->connect_error) {
                                  ...
                                  $stmt = $conn->prepare("insert into requstcars(Name, Phone, Company, Model, 
                                Year, Mileage, OfferingPrice, Options, Specifications, Description)
                                values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                  $stmt->bind_param("sissiiisss", $Name, $Phone, $Company, $model, $Year, $Mileage, $OfferingPrice, $Options, $Specifications, $Description);
