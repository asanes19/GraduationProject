...
?>
 ...
 <section class="Upperform">
                <div style="display: flex; justify-content: center; text-align: center;">
                        ...
                        <img style="width:100%;" src="../assets/img/sellcar2.jpg">
                        <div style="background-color: hsla(0, 0%, 100%, .1); width:100%; margin: 20px; border-radius: 10px;">
                        <p style="margin: 10px; text-align: justify;" class="about__card-description">We kindly request you to share your car's information along with your contact number with us. Upon receiving your details, we will review the information and if interested in purchasing your car, we will get in touch with you at the earliest convenience.</p>
                            </div>
                        </div>
                        <div class="vl"></div>
                        ...
                        <form action="" method="POST" class="Sell1Form">
                          ...
                          <?php if (
                            ...
                            if ($conn->connect_error) {
                                ...
                                $stmt = $conn->prepare("insert into sellsoffers(Name, Phone, Company, Model, 
                                Year, Mileage, AskingPrice, Options, Specifications, Description)
                                values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                $stmt->bind_param("sissiiisss", $Name, $Phone, $Company, $model, $Year, $Mileage, $AskingPrice, $Options, $Specifications, $Description);
